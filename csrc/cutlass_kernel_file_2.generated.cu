...
template void sm90_generic_mixed_gemm_kernelLauncher<half, cutlass::uint2b_t, half, half, half,
cutlass::WeightOnlyQuantOp::PER_COLUMN_SCALE_ONLY, tensorrt_llm::cutlass_extensions::EpilogueOpBias,
cute::Shape<cute::Int<128>, cute::Int<16>, cute::Int<64>>, cute::Shape<cute::Int<1>, cute::Int<1>, cute::Int<1>>,
cutlass::gemm::KernelTmaWarpSpecializedCooperativeMixedInput, cutlass::epilogue::TmaWarpSpecializedCooperative> (
const half*, const cutlass::uint2b_t*, const half*, const half*, const half*, const float,
half*, int, int, int, const int, tensorrt_llm::cutlass_extensions::CutlassGemmConfig, char*, size_t, cudaStream_t, int*
);
...
template void sm90_generic_mixed_gemm_kernelLauncher<__nv_bfloat16, cutlass::uint2b_t, __nv_bfloat16, __nv_bfloat16, __nv_bfloat16,
cutlass::WeightOnlyQuantOp::PER_COLUMN_SCALE_ONLY, tensorrt_llm::cutlass_extensions::EpilogueOpBias,
cute::Shape<cute::Int<128>, cute::Int<16>, cute::Int<64>>, cute::Shape<cute::Int<1>, cute::Int<1>, cute::Int<1>>,
cutlass::gemm::KernelTmaWarpSpecializedCooperativeMixedInput, cutlass::epilogue::TmaWarpSpecializedCooperative> (
const __nv_bfloat16*, const cutlass::uint2b_t*, const __nv_bfloat16*, const __nv_bfloat16*, const __nv_bfloat16*, const float,
__nv_bfloat16*, int, int, int, const int, tensorrt_llm::cutlass_extensions::CutlassGemmConfig, char*, size_t, cudaStream_t, int*
);
